...
) ENGINE=InnoDB AUTO_INCREMENT=32 DEFAULT CHARSET=utf8 COMMENT='结题附件';
...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='结题信息表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `pm_finish_info` VALUES (4,3,1,1,0),(5,16,2,1,0),(6,17,2,2,0),(8,7,2,1,0);
...
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8 COMMENT='经费预算/实际支出信息表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pm_item_attach` (
  ...
  PRIMARY KEY (`attach_id`)
) ENGINE=InnoDB AUTO_INCREMENT=30 DEFAULT CHARSET=utf8 COMMENT='附件表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8 COMMENT='项目立项申请表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sys_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=52 DEFAULT CHARSET=utf8mb4 COMMENT='系统日志';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sys_menu` (
  ...
  PRIMARY KEY (`menu_id`)
) ENGINE=InnoDB AUTO_INCREMENT=85 DEFAULT CHARSET=utf8mb4 COMMENT='菜单管理';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_user_token` VALUES (1,'c1a35b91d4d0e75ead471f252b340083','2019-12-04 10:30:12','2019-12-03 22:30:12'),(2,'19468a5291e2440c11a6524370b37c64','2019-12-04 10:53:00','2019-12-03 22:53:00'),(3,'7d165b30893f12cbdf9b0372fbc47134','2019-12-04 10:15:15','2019-12-03 22:15:15');
...
-- Dump completed on 2019-12-03 23:03:40

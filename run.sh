...
# 初始化数据库
echo -e "\033[42;34m Init databases pmsocspscs \033[0m"

INIT_RESULT=`docker exec $master_container sh -c 'export MYSQL_PWD='$root_password'; mysql -h localhost -P3306 -uroot pmsocspsc < /tmp/sql/pmsocspsc.sql'`

if [ 0 -eq $? ];then
    echo -e "\033[42;34m Init databases executed successfully  \033[0m"
fi
